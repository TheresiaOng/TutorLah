...
export default function PaymentPopup({ onPay, onCancel }: { onPay: () => void; onCancel: () => void }) {
  return (
    <View style={styles.popupContainer}>
      ...
      <View style={styles.row}>
        <Image source={require("../assets/images/hatLogo.png")} style={styles.avatar} />
      ...
      <View style={styles.detailRow}>
        <Image source={require("../assets/images/calender.png")} style={styles.avatar}/>
